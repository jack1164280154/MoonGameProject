...
[CreateAssetMenu(menuName = "SurvivalGames/Managers/Input", fileName = "InputManager")]
public class InputManager : Manager<InputManager>
{
    ...
    private static readonly List<InputContextGroup> m_Contexts = new List<InputContextGroup>();
